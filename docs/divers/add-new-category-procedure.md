...
- **Important:** Always keep `category_7` last, as it is the special _"Autre"_ option.
...
Deploy the database changes to production (refer to `README` § _Base de données_):
